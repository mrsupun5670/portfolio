 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const N1=ct.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:i,className:r="",children:s,iconNode:o,...a},l)=>ct.createElement("svg",{ref:l,...L1,width:e,height:e,stroke:t,strokeWidth:i?Number(n)*24/Number(e):n,className:Xv("lucide",r),...!s&&!P1(a)&&{"aria-hidden":"true"},...a},[...o.map(([c,f])=>ct.createElement(c,f)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.522.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fn=(t,e)=>{const n=ct.forwardRef(({className:i,...r},s)=>ct.createElement(N1,{ref:s,iconNode:e,className:Xv(`lucide-${R1(Zp(t))}`,`lucide-${t}`,i),...r}));return n.displayName=Zp(t),n};/**
 * @license lucide-react v0.522.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
